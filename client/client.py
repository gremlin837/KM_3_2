...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.spin_load.setRange(1, 5000);
        self.spin_load.setValue(400)
        self.spin_blocks = QSpinBox();
        self.spin_blocks.setRange(1, 20);
        self.spin_blocks.setValue(2)
        self.spin_nom_pow = QDoubleSpinBox();
        self.spin_nom_pow.setRange(50, 1000);
        self.spin_nom_pow.setValue(300)
        self.spin_nom_eff = QDoubleSpinBox();
        self.spin_nom_eff.setRange(0.1, 0.99);
        self.spin_nom_eff.setSingleStep(0.01);
        self.spin_nom_eff.setValue(0.38)
        self.spin_temp = QDoubleSpinBox();
        self.spin_temp.setRange(-50, 60);
        self.spin_temp.setValue(25)
        self.spin_hum = QDoubleSpinBox();
        self.spin_hum.setRange(0, 100);
        self.spin_hum.setValue(60)
        self.spin_wind_s = QDoubleSpinBox();
        self.spin_wind_s.setRange(0, 50);
        self.spin_wind_s.setValue(3)
        self.spin_wind_d = QDoubleSpinBox();
        self.spin_wind_d.setRange(0, 359);
        self.spin_wind_d.setValue(90)
        self.spin_beta = QDoubleSpinBox();
        self.spin_beta.setRange(0.2, 0.6);
        self.spin_beta.setValue(0.4)
        self.spin_own_needs = QDoubleSpinBox();
        self.spin_own_needs.setRange(0.01, 0.20);
        self.spin_own_needs.setSingleStep(0.01);
        self.spin_own_needs.setValue(0.05)
        ...
        self.spin_cool_temp = QDoubleSpinBox();
        self.spin_cool_temp.setRange(0, 40);
        self.spin_cool_temp.setValue(25)
        self.spin_steam = QDoubleSpinBox();
        self.spin_steam.setRange(50, 2000);
        self.spin_steam.setValue(400)
        ...
        self.label_vac_res = QLabel("Результат: —");
        self.label_vac_res.setStyleSheet("font-size: 14pt; color: #2e7d32; font-weight: bold;")
    ...
    def _show_stub_dialog(self):
        QMessageBox.information(self, "Информация",
                                "Диалог смены пароля будет подключен после интеграции с server/auth/.\nСейчас используется тестовый режим.")
