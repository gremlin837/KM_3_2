...
class Config:
    ...
    # В класс Config, после существующих @property:
    @property
    def jwt_secret(self):
        return self.config.get('AUTH', 'jwt_secret', fallback='dev-secret-key-change-in-prod')

    @property
    def jwt_algorithm(self):
        return self.config.get('AUTH', 'jwt_algorithm', fallback='HS256')
